...
var months = ['JANUARY','FEBRUARY','MARCH','APRIL','MAY','JUNE','JULY','AUGUST','SEPTEMBER','OCTOBER','NOVEMBER','DECEMBER'],
		...
		DCalendar = function(elem, options) {
			...
			if(options.mode === 'calendar')
				this.tHead = $('<thead><tr><th id="currY"></th></tr><tr><th id="prev">&lsaquo;</th><th colspan="5" id="currM"></th><th id="next">&rsaquo;</th></tr><tr><th>Su</th><th>Mo</th><th>Tu</th><th>We</th><th>Th</th><th>Fr</th><th>Sa</th></tr></thead>');
			else if (options.mode === 'datepicker')
				this.tHead = $('<thead><tr><th id="currY"></th></tr><tr><th id="prev">&lsaquo;</th><th colspan="5" id="currM"></th><th id="next">&rsaquo;</th></tr><tr><th>S</th><th>M</th><th>T</th><th>W</th><th>T</th><th>F</th><th>S</th></tr></thead>');
		...
		create : function(mode){
			...
			if(mode === "days") {
				if(that.options.mode === 'calendar') {
					that.tHead = $('<thead><tr><th id="currY"></th></tr><tr><th id="prev">&lsaquo;</th><th colspan="5" id="currM"></th><th id="next">&rsaquo;</th></tr><tr><th>Su</th><th>Mo</th><th>Tu</th><th>We</th><th>Th</th><th>Fr</th><th>Sa</th></tr></thead>');
				} else if (that.options.mode === 'datepicker') {
					that.tHead = $('<thead><tr class="calendarYear"><th colspan="7" id="currY"></th></tr><tr  class="calendarMonth"><th id="prev"><img src="img/small_back1.png"></th><th colspan="5" id="currM"></th><th id="next"><img src="img/small_back.png"></th></tr><tr  class="calendarDays"><th>SUN</th><th>MON</th><th>TUE</th><th>WED</th><th>THU</th><th>FRI</th><th>SAT</th></tr></thead>');
				}
				/******************Month with year*********************/
				that.tHead.find('#currM').text(months[that.date.getMonth()] );
				...
				this.tHead = $('<thead><tr><th id="currY"></th></tr>       <tr><th id="prev">&lsaquo;</th><th colspan="2" id="currM"></th><th id="next">&rsaquo;</th></tr>');
